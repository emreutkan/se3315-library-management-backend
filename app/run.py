    ...
    with app.app_context():
        ...
        if not Book.query.first():
            books = [
                ...
                Book(title='Bilinmeyen Bir Kadının Mektubu', author='Stefan Zweig', isbn='9786052950366', category='Psikoloji'),
                Book(title='Küçük Prens', author='Antoine de Saint-Exupéry', isbn='9789750719400', category='Çocuk'),
                Book(title='Tutunamayanlar', author='Oğuz Atay', isbn='9789754700114', category='Postmodern'),
                Book(title='Bir İdam Mahkumunun Son Günü', author='Victor Hugo', isbn='9786053322896', category='Felsefe'),
                ...
                Book(title='Böyle Buyurdu Zerdüşt', author='Friedrich Nietzsche', isbn='9786052951424', category='Felsefe'),
